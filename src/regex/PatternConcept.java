...
public class PatternConcept {
	...
	public static void main(String[] args) {
		...
		pat = Pattern.compile("\\d(2,4)"); // represents any number
		mat = pat.matcher("100000");
		System.out.println("For \\d(2,4):" + mat.matches());
		...
		pat = Pattern.compile("\\w"); // represents single char or we can use _ as character here.
		mat = pat.matcher("v");
